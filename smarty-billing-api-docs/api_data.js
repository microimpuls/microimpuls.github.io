define({ "api": [
  ...
  {
    "type": "post",
    "url": "/account/camera/create/",
    "title": "AccountCameraCreate: привязка камеры к аккаунту",
    "name": "AccountCameraCreate",
    "group": "Account",
    "version": "1.40.0",
    "filename": "../../../billing/api.py",
    "groupTitle": "Account",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "camera_id",
            "description": "<p>Идентификатор камеры. Можно передать несколько значений (через запятую).</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "3",
            "description": "<p>Камера по идентификатору не найдена.</p>"
          }
        ]
      }
    }
  ...
  {
    "type": "post",
    "url": "/account/camera/delete/",
    "title": "AccountCameraDelete: удаление привязанной камеры у аккаунта",
    "name": "AccountCameraDelete",
    "group": "Account",
    "version": "1.40.0",
    "filename": "../../../billing/api.py",
    "groupTitle": "Account",
  ...
  },
  {
    "type": "get",
    "url": "/account/list/",
    "title": "AccountList: Список аккаунтов",
    "name": "AccountList",
    "group": "Account",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>Cтатус аккаунта.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "status_reason",
            "description": "<p>Описание дополнительного статуса аккаунта.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "abonement_regexp",
            "defaultValue": "пустое",
            "description": "<p>Регулярное выражение для фильтрации аккаунтов.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
        ...
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "accounts",
            "description": "<p>Список аккаунтов.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "accounts.auto_activation_period",
            "description": "<p>Количество дней, на которое будет автоматически активирован аккаунт после первой авторизации.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "optional": false,
            "field": "accounts.activation_date",
            "description": "<p>Дата активации аккаунта.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.deactivation_date",
            "description": "<p>Дата деактивации аккаунта.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.allow_multiple_login",
            "description": "<p>Разрешить неограниченное количество одновременных подлючений для этого аккаунта с любых IP-адресов.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.allow_login_by_abonement",
            "description": "<p>Разрешить авторизацию только по логину (без пароля).</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.allow_login_by_device_uid",
            "description": "<p>Разрешить авторизацию по UID устройства (без логина и пароля).</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.allow_login_by_ip",
            "description": "<p>Разрешить авторизацию по IP-адресу (без логина и пароля).</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "accounts.preferred_timeshift_offset",
            "description": "<p>Предпочитаемый сдвиг по времени.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "accounts.devices.system_name",
            "description": "<p>Системное название типа устройства.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "accounts.devices.device_uid",
            "description": "<p>UID / MAC-адрес.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "accounts.devices.serial_number",
            "description": "<p>Серийный номер.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "accounts.devices.created_at",
            "description": "<p>Дата регистрации.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.devices.is_basic",
            "description": "<p>Является базовым.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "accounts.subscriptions.tariff_id",
            "description": "<p>ID тарифа.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "accounts.subscriptions.api_config_id",
            "description": "<p>ID внешнего API (null, если не задано).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "accounts.subscriptions.price",
            "description": "<p>Стоимость подписки.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.subscriptions.start_date",
            "description": "<p>Начало действия.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.subscriptions.end_date",
            "description": "<p>Окончание действия подписки (null, если подписка бесконечная).</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "accounts.subscriptions.is_periodical",
            "description": "<p>Является ли подписка периодической.</p>"
          },
          {
            "group": "Ответ",
  ...
  },
  {
    "type": "post",
    "url": "/authkey/delete/",
    "title": "AuthkeyDelete: удаление сессии",
    "name": "AccountModify",
    "group": "Account",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "authkey_key",
            "description": "<p>Строка ключа. Должен быть передан либо ID, либо ключ.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Ошибка валидации данных.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "send_sms_messages",
            "defaultValue": "1",
            "description": "<p>Отправлять уведомления через sms.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": true,
            "field": "send_email_messages",
            "defaultValue": "1",
            "description": "<p>Отправлять уведомления через email.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
  ...
  },
  {
    "type": "get",
    "url": "/customer/list/",
    "title": "CustomerList: Список абонентов",
    "name": "CustomerList",
    "group": "Customer",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "customers.accounts.abonement",
            "description": "<p>Абонемент.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "customers.accounts.activation_days_left",
            "description": "<p>Количество оставшихся дней активации. Рассчитывается как разница между датой деактивации и датой активации. При использовании внешнего биллинга это значение можно игнорировать.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.accounts.on_trial_period",
            "description": "<p>(1-Аккаунт находится в пробном периоде, 0-нет)</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "customers.subscriptions.tariff_id",
            "description": "<p>ID тарифа.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "customers.subscriptions.api_config_id",
            "description": "<p>ID внешнего API (null, если не задано).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "customers.subscriptions.price",
            "description": "<p>Стоимость подписки.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.subscriptions.start_date",
            "description": "<p>Начало действия.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.subscriptions.end_date",
            "description": "<p>Окончание действия подписки (null, если подписка бесконечная).</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.subscriptions.is_periodical",
            "description": "<p>Является ли подписка периодической.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.subscriptions.price_expiration",
            "description": "<p>Окончание действия цены (null, если отсутствует).</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.subscriptions.is_price_overridden",
            "description": "<p>Используется ли переопределение цены.</p>"
          },
          {
            "group": "Ответ",
            ...
            "optional": false,
            "field": "customers.subscriptions.is_closed",
            "description": "<p>Является ли подписка закрытой.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "customers.payments_count",
            "description": "<p>Количество всех подтвержденных транзакций.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "customers.tariffs_info.id",
            "description": "<p>Идентификатор тарифа.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "customers.tariffs_info.ext_id",
            "description": "<p>Идентификатор тарифа в биллинговой системе провайдера.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "customers.vtariffs_info.id",
            "description": "<p>Идентификатор тарифа.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "customers.vtariffs_info.ext_id",
            "description": "<p>Идентификатор тарифа в биллинговой системе провайдера.</p>"
          },
          {
            "group": "Ответ",
  ...
  },
  {
    "type": "get",
    "url": "/promo/create/",
    "title": "PromoCreate: создание промо-кода",
    "name": "PromoCreate",
    "group": "Promo",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "valid_from",
            "description": "<p>Дата, с которой действителен промокод.</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            ...
            "optional": true,
            "field": "valid_until",
            "description": "<p>Дата, до которой действителен промокод.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "description": "<p>Количество активаций. По умолчанию: 1.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": true,
            "field": "tariffs",
            "description": "<p>Список id тарифов со скидкой (через запятую).</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "available_to_unsubscribe",
            "defaultValue": "1",
            "description": "<p>Доступен для отключения через TVMW API.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
