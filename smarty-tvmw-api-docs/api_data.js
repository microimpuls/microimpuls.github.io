define({ "api": [
  ...
  },
  {
    ...
    "title": "AccountSettingsModify: установка типа профиля для текущей сессии аккаунта",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>Флаг указывает что для канала на данный момент включена реклама.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
