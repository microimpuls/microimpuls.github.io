define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/camera/list",
    "title": "CameraList: список телеканалов",
    "name": "ChannelList",
    "group": "Channel",
    "parameter": {
      "fields": {
    ...
    "version": "1.40.0",
    "filename": "../../../tvmiddleware/tv_api/camera.py",
    "groupTitle": "Channel"
  },
  {
    "type": "get",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "ads",
            "description": "<p>Список рекламных блоков, соответствующих данному каналу. Требует включения параметра TVMIDDLEWARE_ADS_ENABLED в Smarty.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "ads.days",
            "description": "<p>Перечисление дней (через запятую), в которые необходимо воспроизводить данный рекламный блок.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Время начала диапазона рекламного блока в формате ЧЧ:ММ:СС.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "ads.end_time",
            "description": "<p>Время окончания диапазона рекламного блока в формате ЧЧ:ММ:СС.</p>"
          },
          {
            "group": "Ответ",
            "type": "Object[]",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "ads",
            "description": "<p>Список рекламных блоков, соответствующих данному каналу. Требует включения параметра TVMIDDLEWARE_ADS_ENABLED в Smarty. Null при запросе камеры.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "order",
            "defaultValue": "пустой",
            "description": "<p>Сортировка, -created_at - по дате добавления в каталог, сначала самые новые; created_at - по дате добавления в каталог, сначала самые старые; -premiere_date - по дате премьеры, сначала самые новые; premiere_date - по дате премьеры, сначала самые старые; -year - по дате выхода фильма, сначала самые новые; year - по дате выхода фильма, сначала самые старые; -name - по названию, в обратном алфавитном порядке; name - по названию, в алфавитном порядке; -average_customers_rating - по рейтингу абонентов, сначала самые популярные; average_customers_rating - по рейтингу абонентов, сначала самые непопулярные; -kinopoisk_rating - по рейтингу Кинопоиска, сначала самые популярные; kinopoisk_rating - по рейтингу Кинопоиска, сначала самые непопулярные; -imdb_rating - по рейтингу IMDB, сначала самые популярные; imdb_rating - по рейтингу IMDB, сначала самые непопулярные; -view_datetime - по дате промотра, сначала самые ранние (только с флагом is_viewed); view_datetime - по дате промотра, сначала самые поздние (только с флагом is_viewed).</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
