        ...
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "usage",
            "description": "<p>Значение нагрузки на сервер. Определяется как максимальное из отношений средней загрузки к максимальной средней загрузке и использованной памяти к максимальной использованой памяти. Максимальная средняя загрузка и максимальная использованная память задаются в конфигурационном файле.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
