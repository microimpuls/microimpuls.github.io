      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "session_id",
            "description": "<p>ID платежной сессии. Передается через POST.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "description": "<p>Внутренний ID платежа (ID, используемый в Smarty). Передается через POST.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "merchant_type",
            "defaultValue": "пустое",
            "description": "<p>Тип мерчанта. Передается через POST.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "pares",
            "description": "<p>Результат 3ds аутентификации. Передается через POST.</p>"
          }
        ]
      }
    },
