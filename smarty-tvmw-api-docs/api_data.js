define({ "api": [
  {
    "type": "get",
    "url": "/account/export/",
    "title": "AccountExport: перенос аккаунта с другого сервиса",
    "name": "AccountExport",
    "group": "Account",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "service_id",
            "description": "<p>ID клиента smarty, с которого переносится аккаунт.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "login",
            "description": "<p>Логин аккаунта.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "password",
            "description": "<p>Пароль от аккаунта.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "error_message",
            "description": "<p>Сообщение об ошибке.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "3",
            "description": "<p>Функционал недоступен.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/account/profile/settings/modify/",
    "title": "AccountProfileSettingsModify: редактирование профиля аккаунта",
    "name": "AccountProfileSettingsModify",
    "group": "Account",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "profile_id",
            "description": "<p>Идентификатор типа профиля.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "name",
            "description": "<p>Имя профиля аккаунта.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Некорректное значение profile_id.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "2",
            "description": "<p>Некорректное значение name.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "parent_code",
            "description": "<p>ПИН-код аккаунта.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "field": "external",
            "defaultValue": "0",
            "description": "<p>Использовать только External API для регистрации.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "login",
            "description": "<p>Логин, используется для поиска аккаунта в External API.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>Номер телефона, на который должен осуществить звонок абонент для подтверждения своего номера телефона.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "19",
            "description": "<p>Было отправлено подтверждение номера телефона с помощью кода в телефонном номере.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "20",
            "description": "<p>Неверный код верификации из кода в телефонном номере.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "21",
            "description": "<p>Ожидается подтверждение номера телефона с помощью смс-кода.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "22",
            "description": "<p>Ожидается подтверждение номера телефона с помощью кода в телефонном номере.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "5",
            "description": "<p>Код верификации не корректен или устарел.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
          ...
          },
          {
            ...
            "optional": false,
            "field": "7",
            "description": "<p>Код уже отправлен.</p>"
          }
        ]
      }
    },
        ...
        "Ответ": [
          {
            ...
            "description": "<p>Список профилей аккаунта.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "account_settings.name",
            "description": "<p>Название профиля аккаунта.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "account_settings.profile_id",
            "description": "<p>Идентификатор типа профиля.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "account_settings.profile_name",
            "description": "<p>Название типа профиля.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "command.user_confirmation",
            "description": "<p>Флаг, показывающий, необходимо ли запрашивать подтверждение пользователя.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "command.deep_link",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "command.accompanying_text_to_command",
            "description": "<p>Сопроводительное сообщение к команде.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
  ...
  {
    "type": "get",
    "url": "/channel/list/last/",
    "title": "ChannelListLast: список последних просмотренных аккаунтом каналов",
    "name": "ChannelListLast",
    "group": "Account",
    "success": {
      "fields": {
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "channels",
            "description": "<p>Список последних просмотренных аккаунтом каналов.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<p>Общее количество актеров.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "ads.movies.skipoffset",
            "description": "<p>Через сколько времени можно пропустить креатив.</p>"
          },
          {
            "group": "Ответ",
            "type": "Object[]",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "ads.events.url",
            "description": "<p>Url события.</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "appid",
            "description": "<p>Идентификатор приложения. Может быть передан через POST</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "2",
            "description": "<p>Неправильный ID</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "ext_city_id",
            "defaultValue": "пустое",
            "description": "<p>Идентификатор города в сервисе прогноза погоды.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "23",
            "description": "<p>Неверный код верификации из кода в телефонном номер.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
  ...
  },
  {
    "type": "get",
    "url": "/login/ext/",
    "title": "LoginExt: создание сессии. Только внешние вызовы, без создания сессии на стороне smarty.",
    "name": "LoginExt",
    "group": "Authorization",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "16",
            "description": "<p>Ошибка запроса authkey из внешнего биллинга.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "category_id",
            "description": "<p>ID epg категории камеры.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "actions.action",
            "description": "<p>Имя действия, одно из зарезервированных значений: get_channel_url – получить адрес потока; subscribe – купить подписку на пакет. Данное действие недоступно для старой логики и не будет входить в варианты покупки.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>Значение параметра канала Option 1 (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Значение параметра канала Option 2 (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Значение параметра канала Option 3 (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Телеизмеритель (не возвращается при compact=1). Если указано, а также указаны параметры измерителя в PortalSettingsList, то приложению необходимо отправлять данные статистики просмотра канала на сервер измерителя.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>AccountName на сервере измерителя (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>TmsecName на сервере измерителя (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Категория контента на сервере измерителя (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Идентификатор контента на сервере измерителя (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Версия контента на сервере измерителя (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Соотношение сторон данного канала (не возвращается при compact=1). 0 - Авто. 1 - 16:9. 2 - 4:3. 3 - На весь экран.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Логический номер канала (LCN) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Object[]",
            "optional": false,
            "field": "channels.hbb",
            "description": "<p>Список доступных HbbTV-провайдеров (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Список доп. категорий канала (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Дополнительные расширенные данные о передаче EPG (в формате JSON) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>Список жанров текущей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Идентификатор следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Название следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Начало следующей передачи EPG в формате Unix Timestamp UTC+0 (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Конец следующей передачи EPG в формате Unix Timestamp UTC+0 (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Идентификатор категории EPG следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Название категории EPG следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Описание следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>URL-адрес обложки следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Возрастной рейтинг следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Дополнительные расширенные данные о следующей передаче EPG (в формате JSON) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>Список жанров следующей передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Отображать канал в категории Все (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "optional": false,
            "field": "channels.ads_available",
            "description": "<p>Флаг указывает что для канала на данный момент включена реклама (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "2",
            "description": "<p>Список каналов является некорректным.</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "search",
            "description": "<p>Строка поиска. Поиск осуществляется по вхождению подстроки в название канала.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>URL иконки канала (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Название канала (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Описание премьеры (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Дополнительная информация о премьере в формате JSON (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>Название категории EPG передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Описание передачи EPG (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Начало передачи EPG в формате Unix Timestamp UTC+0 (без учета часового сдвига) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Конец передачи EPG в формате Unix Timestamp UTC+0 (без учета часового сдвига) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
  ...
  {
    "type": "get",
    "url": "/channel/sort/list/",
    "title": "ChannelSortList: список сортировок каналов",
    "name": "ChannelSortList",
    "group": "Channel",
    "success": {
      "fields": {
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "channel_sort",
            "description": "<p>Список сортировок каналов.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "channel_sort.id",
            "description": "<p>Идентификатор списка сортировки.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "channel_sort.name",
            "description": "<p>Название списка сортировки.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "archive_preview_url_mask",
            "description": "<p>Маска url для получения превью-изображения из архива (используется для flussonic).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
  ...
  {
    "type": "get",
    "url": "/content/position/delete/",
    "title": "ContentPositionDelete: удаление позиции просмотра контента (передачи или фильма)",
    "name": "ContentPositionDelete",
  ...
  {
    "type": "get",
    "url": "/content/position/remember/channel/",
    "title": "ContentPositionRememberChannel: добавление канала в список последних просмотренных",
    "name": "ContentPositionRememberChannel",
    "group": "ContentPosition",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Коды ошибок error": [
          {
            ...
            "optional": false,
            "field": "0",
            "description": "<p>Нет ошибки, канал успешно сохранён.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "tariffs.price_after_activation",
            "description": "<p>Стоимость покупки за полный период.</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "tariffs.subscription_end_date",
            "description": "<p>Дата окончания подписки, если абонент подписан на данный тариф.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "payment_sum_no_discount",
            "description": "<p>Сумма платежа за установленный период без учёта скидки.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "tariff_id",
            "description": "<p>Идентификатор тарифа. Должен быть передан либо параметр tariff_id, либо virtual_tariff_id. Можно передать несколько значений (через запятую).</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Один или несколько из переданных тарифов не доступны или не существуют.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "5",
            "description": "<p>Один из переданных тарифов недоступен для отключения через TVMW API.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "provider_id",
            "description": "<p>ID интеграции API кинотеатра.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": true,
            "field": "video_provider_id",
            "description": "<p>ID видео-провайдера.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": true,
            "field": "category_id",
            "description": "<p>ID жанра-категории. Если указано, то количество фильмов в жанре будет рассчитываться только от фильмов этой категории</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "log_events",
            "description": "<p>POST параметр. Список событий (body).</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "error_info",
            "description": "<p>POST параметр. Информация об ошибке в формате JSON.</p>"
          },
          {
            "group": "Success 200",
            "type": "Object[]",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "120",
            "description": "<p>Ошибка обращения ко внешнему ресурсу.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "document_type",
            "defaultValue": "пустое",
            "description": "<p>Фильтр по типу документа. 1 - Показывать при авторизации. 2 - Показывать при регистрации. 3 - Показывать при оплате. 4 - Показывать при подключении тарифа.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
        ...
        "Коды ошибок error": [
          {
            ...
            "optional": false,
            "field": "0",
            "description": "<p>Нет ошибки, напоминание удалено успешно.</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "card_id",
            "description": "<p>POST параметр. Идентификатор карты.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
  ...
  },
  {
    ...
    "title": "PaymentComplete: инициация проверки статуса платежа",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "session_id",
            "description": "<p>POST параметр. ID платежной сессии.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "description": "<p>POST параметр. Внутренний ID платежа (ID, используемый в Smarty).</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>Статус транзакции. 0 - необработана, 1 - подтверждена, 2 - ошибка.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Транзакция, соответствующая переданному ID, не найдена.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "2",
            "description": "<p>Ошибка платежного шлюза.</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "field": "template",
            "defaultValue": "пустое",
            "description": "<p>POST параметр. Имя шаблона (если есть поддержка шлюзом).</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "amount",
            "description": "<p>POST параметр. Cумма платежа.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
  ...
  {
    "type": "post",
    "url": "/payment/pares/process/",
    "title": "PaymentPAResProcess: обработка результатов 3ds аутентификации",
    "name": "PaymentPAResProcess",
    "group": "Payment",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "card_number",
            "description": "<p>POST параметр. номер карты.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "card_holder",
            "description": "<p>POST параметр. имя владельца карты.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "card_expire",
            "description": "<p>POST параметр. Срок действия карты.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "card_cvv",
            "description": "<p>POST параметр. cvv карты.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "pares",
            "description": "<p>POST параметр. Результат 3ds аутентификации.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    "type": "post",
    "url": "/payment/preauth/",
    "title": "PaymentPreAuth: предварительная аутентификация",
    "name": "PaymentPreAuth",
    "group": "Payment",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "color_depth",
            "description": "<p>POST параметр. Глубина цветопередачи устройства клиента в битах.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "screen_height",
            "description": "<p>POST параметр. Общая высота экрана Абонента в пикселях.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "screen_width",
            "description": "<p>POST параметр. Общая ширина экрана Абонента в пикселях.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "window_height",
            "description": "<p>POST параметр. Высота окна браузера Абонента в пикселях, в котором отображаются страницы сайта.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "window_width",
            "description": "<p>POST параметр. Ширина окна браузера Абонента в пикселях, в котором отображаются страницы сайта.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "lang",
            "description": "<p>POST параметр. Язык браузера Абонента.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "timezone",
            "description": "<p>POST параметр. Часовой пояс Абонента в минутах.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": false,
            "field": "java_enabled",
            "description": "<p>POST параметр. Признак возможности выполнения JavaScript в браузере Абонента.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
        ...
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "success",
            "description": "<p>Флаг успешной предварительной аутентификации.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "version",
            "description": "<p>Версия 3DS.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "iframe_kwargs.three_DS_server_trans_id",
            "description": "<p>Идентификатор 3DS метода.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "iframe_kwargs.three_DS_method_url",
            "description": "<p>Url для открытия скрытого iframe.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "iframe_kwargs.three_DS_method_notification_url",
            "description": "<p>Адрес платежного шлюза для получения от ACS информации о выполнении 3DS метода.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "payment_id",
            "description": "<p>POST параметр. Внешний ID платежа (ID, используемый в шлюзе).</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
  ...
  {
    "type": "get",
    "url": "/portaldashboard/channel/list/",
    "title": "PortalDashboardChannelList: список каналов",
    "name": "PortalDashboardChannelList",
  ...
  {
    "type": "get",
    "url": "/portaldashboard/list/",
    "title": "PortalDashboardList: список доступных лент и их типов для текущего устройства и шаблона",
    "name": "PortalDashboardList",
    "group": "PortalDashboard",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Ответ": [
          {
            ...
            "type": "Object[]",
            "optional": false,
            "field": "portaldashboards",
            "description": "<p>Список доступных лент.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "portaldashboards.id",
            "description": "<p>Идентификатор ленты.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "portaldashboards.type",
            "description": "<p>Тип ленты. Возможные значения: 0 - Главное меню; 1 - Виджеты; 2 - Телеканалы; 3 - Передачи; 4 - Фильмы; 5 - Подборка; 6 - Недавно просмотренные телеканалы; 7 - Недавно просмотренные передачи; 8 - Недавно просмотренные фильмы; 9 - Слайдер; 10 - Плеер.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "programs.channel_icon_url",
            "description": "<p>URL-адрес иконки канала.</p>"
          },
          {
            "group": "Ответ",
        ...
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "selections",
            "description": "<p>Список подборок последних просмотренных аккаунтом передач.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_stat_enabled",
            "description": "<p>Необходимо ли отправлять данные просмотров на сервер Start для контента Start (если настроена соответствующая интеграция).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
  ...
  },
  {
    "type": "get",
    "url": "/profile/list/",
    "title": "ProfileList: список типов профилей",
    "name": "ProfileList",
    "group": "Profile",
    "success": {
      "fields": {
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "profiles",
            "description": "<p>Список типов профилей.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Флаг, является ли типом профиля по умолчанию.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "optional": false,
            "field": "profiles.show_adult_content",
            "description": "<p>Флаг, показывать ли контент для взрослых.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "defaultValue": "1",
            "description": "<p>Флаг, если передано значение 0, то при распределении каналов между категориями учитываются только статические категории (категории из EpgChannel). Доступно только если параметр конфигурации TVMW_CONSIDER_PROGRAM_CATEGORY имеет значение True.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "defaultValue": "1",
            "description": "<p>Флаг, если передано значение 0, то при распределении каналов между категориями учитываются только динамические категории (категории текущих/следующих передач на каналах). Доступно только если параметр конфигурации TVMW_CONSIDER_PROGRAM_CATEGORY имеет значение True.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>Соотношение сторон данной передачи (не возвращается при compact=1). 0 - Авто. 1 - 16:9. 2 - 4:3. 3 - На весь экран.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "programs.lcn_number",
            "description": "<p>Логический номер канала (LCN) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
          ...
          },
          {
            ...
            "description": "<p>Дополнительная информация о передаче в формате JSON (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>Список жанров передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Идентификатор категории следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Время начала следующей передачи в Unix Timestamp (UTC+0) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Время окончания следующей передачи в Unix Timestamp (UTC+0) (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Название следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Описание следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Название категории следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>URL картинки следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Идентификатор следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Возрастной рейтинг следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Дополнительная информация о следующей передаче в формате JSON (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>Список жанров следующей передачи (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Временной сдвиг для функции Pause Live TV (не возвращается при compact=1).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "description": "<p>Название типа иконки категории.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>URL-адрес иконки для мобильных устройств.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "categories.icon_tv",
            "description": "<p>URL-адрес иконки для STB и Smart TV.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "pid_from",
            "description": "<p>Идентификатор передачи, дата начала которой будет считаться, как дата начала диапазона выборки.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Передачи, соответствующей pid_from, не существует.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "preview_url_mask",
            "description": "<p>Маска url для получения превью-изображения (используется для flussonic).</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
  ...
  },
  {
    "type": "get",
    "url": "/promo/activate/",
    "title": "PromoActivate: активация промо-кода",
    "name": "PromoActivate",
    "group": "Promo",
    "parameter": {
      "fields": {
        ...
        "Ответ": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>Тип промо (deprecated). 0 - Добавление суммы к балансу. 1 - Активация скидки.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Промокод не найден.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "2",
            "description": "<p>Ошибка валидации промо-кода.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "3",
            "description": "<p>Промо-код уже активирован.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "4",
            "description": "<p>Срок действия истёк или ещё не наступил.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "promos.status",
            "description": "<p>Статус промокода. 1 - Промокод назначен, но не применен. 2 - Промокод применен.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "providers.icon_url",
            "description": "<p>URL иконки провайдера.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "providers.movie_label_icon",
            "description": "<p>URL изображения для маркировки обложек фильмов.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "providers.movie_label_icon_black_bg",
            "description": "<p>URL изображения для маркировки обложек фильмов для тёмного фона.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            ...
            "description": "<p>Тип провайдера: 0 - Нет типа 1 - Megogo 2 - Tvzavr 3 - START 4 - Premier</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "seances.vfid",
            "description": "<p>ID ассета видео. Если ассета нет, то поле пустое.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "seances.video_name",
            "description": "<p>Название видео.</p>"
          },
          {
            "group": "Ответ",
            "type": "Date",
          ...
          },
          {
            ...
            "optional": false,
            "field": "seances.date_end",
            "description": "<p>Дата окончания сеанса. Формат ISO-8601.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "sid",
            "description": "<p>ID сеанса. Должен быть передан либо код, либо ID. Учитываются только билеты и сеансы, которые привязаны к авторизованному аккаунту.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "3",
            "description": "<p>Сеанс уже прошел.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
          ...
          },
          {
            ...
            "optional": false,
            "field": "5",
            "description": "<p>Билет не активирован.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
            "field": "6",
            "description": "<p>Ошибка доступа.</p>"
          },
          {
            "group": "Коды ошибок error",
            "optional": false,
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "Number",
            "description": "<p>program_id Идентификатор передачи EPG.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Передача не найдена (если установлен параметр).</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "channels_sort",
            "description": "<p>POST параметр. Пользовательская сортировка каналов</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": true,
            "field": "channels_sort.id",
            "description": "<p>Идентификатор канала</p>"
          },
          {
            "group": "Parameter",
            ...
            "optional": true,
            "field": "channels_sort.is_parent_control",
            "description": "<p>Флаг, использовать ли для канала защиту PIN кодом</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": true,
            "field": "channels_sort.is_favorited",
            "description": "<p>Флаг, является ли канал изранным для пользователя</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": true,
            "field": "channels_sort.is_hidden",
            "description": "<p>Флаг, нужно ли скрыть данный канал для пользователя</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "device",
            "defaultValue": "пустое",
            "description": "<p>Системное название типа устройства. Является необходимым полем для получения данных от сторонних провайдеров (онлайн-кинотеатров).</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "actions.quality",
            "description": "<p>Качество ассета.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Видео не существует.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "videos.video_provider_id",
            "description": "<p>ID связанного провайдера видео.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "3",
            "description": "<p>Для данного устройства нет доступа.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "defaultValue": "пустое",
            "description": "<p>ID товара во внешней биллинговой системе. По умолчанию используется ext_id фильма. При покупке фильма через интеграцию с кинотеатрами передаётся option_id.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "actions.cost",
            "description": "<p>Сумма списания с баланса при активации (только при использовании внешнего биллинга, имеет больший приоритет, чем activation_price).</p>"
          },
          {
            "group": "Ответ",
            "type": "Decimal",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "actions.subscription_id",
            "description": "<p>Идентификатор трифа-подписки.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Ссылка на внешний ресурс, где находится аватарка пользователя, который оставил отзыв.</p>"
          },
          {
            "group": "Ответ",
            "type": "Object[]",
            "optional": false,
            "field": "seasons",
            "description": "<p>Список сезонов.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
            "optional": false,
            "field": "seasons.id",
            "description": "<p>Идентификатор сезона.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "seasons.name",
            "description": "<p>Название сезона.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            ...
            "description": "<p>Порядоковый номер сезона.</p>"
          },
          {
            "group": "Ответ",
            "type": "Number",
  ...
  {
    "type": "get",
    "url": "/video/episode/detail/",
    "title": "VideoEpisodeDetail: Информация о серии",
    "name": "VideoEpisodeDetail",
    "group": "Video",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "episode_id",
            "description": "<p>Идентификатор серии.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "duration",
            "description": "<p>Длительность серии в минутах (для отображения).</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "preview_url",
            "description": "<p>Превью-изображение.</p>"
          },
          {
            "group": "Ответ",
            "type": "String",
            "optional": false,
            "field": "video_id",
            "description": "<p>Идентификатор видео.</p>"
          },
          {
            "group": "Ответ",
            "type": "Object[]",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Серия не найдена.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "VideoEpisodeList:  Cписок серий для сезона сериала",
      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "episodes.files.promo_image",
            "description": "<p>URL-адрес промо-изображения.</p>"
          },
          {
            "group": "Ответ",
      ...
      "fields": {
        "Коды ошибок error": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Сезон не найден.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "viewed_only",
            "defaultValue": "0",
            "description": "<p>Фильтр по факту просмотренности. При значении 1 в выборку попадут только обьекты, которые были просмотрены абонентом до конца. При значении 0 факт просмотренности не будет проверяться.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "field": "provider",
            "defaultValue": "пустой",
            "description": "<p>Название интеграции API кинотеатра.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": true,
            "field": "provider_id",
            "description": "<p>ID интеграции API кинотеатра. Приоритетнее, чем название, если указано оба.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "field": "order",
            "defaultValue": "пустой",
            "description": "<p>Сортировка, возможные параметры:<br/> <code>-created_at</code> - по дате добавления в каталог, сначала самые новые;<br/> <code>created_at</code> - по дате добавления в каталог, сначала самые старые;<br/> <code>-updated_at</code> - по дате изменения, сначала самые новые;<br/> <code>updated_at</code> - по дате изменения, сначала самые старые;<br/> <code>-premiere_date</code> - по дате премьеры, сначала самые новые;<br/> <code>premiere_date</code> - по дате премьеры, сначала самые старые;<br/> <code>-year</code> - по дате выхода фильма, сначала самые новые;<br/> <code>year</code> - по дате выхода фильма, сначала самые старые;<br/> <code>-name</code> - по названию, в обратном алфавитном порядке;<br/> <code>name</code> - по названию, в алфавитном порядке;<br/> <code>-average_customers_rating</code> - по рейтингу абонентов, сначала самые популярные;<br/> <code>average_customers_rating</code> - по рейтингу абонентов, сначала самые непопулярные;<br/> <code>-kinopoisk_rating</code> - по рейтингу Кинопоиска, сначала самые популярные;<br/> <code>kinopoisk_rating</code> - по рейтингу Кинопоиска, сначала самые непопулярные;<br/> <code>-imdb_rating</code> - по рейтингу IMDB, сначала самые популярные;<br/> <code>imdb_rating</code> - по рейтингу IMDB, сначала самые непопулярные;<br/> <code>-view_datetime</code> - по дате проcмотра, сначала самые ранние (только при запросе с флагом <code>viewed_only=1</code> или <code>is_viewing=1</code>);<br/> <code>view_datetime</code> - по дате проcмотра, сначала самые поздние (только при запросе с флагом <code>viewed_only=1</code> или <code>is_viewing=1</code>).</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
