      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "order",
            "defaultValue": "name",
            "description": "<p>Сортировка, birthdate - по дате рождения, сначала самые старые; -birthdate - по дате рождения, сначала самые новые; name - по имени, в алфавитном порядке; -name - по имени, в обратном алфавитном порядке; name-rufirst - по имени, с приоритетом на имена в кириллице;</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
