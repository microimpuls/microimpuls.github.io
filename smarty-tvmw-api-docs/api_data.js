      ...
      "fields": {
        "Ответ": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "selections.is_available",
            "description": "<p>Доступна ли подборка для просмотра. Может быть ситуация, при которой в подборке есть передачи из доступных пользователю каналов, однако среди каналов пользователя нет подходящего канала в архиве которого можно было бы посмотреть данную подборку.</p>"
          },
          {
            "group": "Ответ",
            "type": "Object",
